...
- `/spatial-demo` — изолированный прототип пространственной навигации: колесо ведет по уровням профиля, опыта, проектов и связанных материалов, а движение тачпада непрерывно перемещает карусели по горизонтали.
