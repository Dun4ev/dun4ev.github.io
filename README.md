...
- `/` — главная страница портфолио; опыт сгруппирован в три плавно раскрываемых карьерных этапа, а база знаний и публикации объединены в раздел «Статьи и заметки».
- `/projects` — единый архив инженерных инструментов, автоматизации, интерактивных концептов, отчетов и презентационных сайтов с фильтрами по типу работы.
- `/labs` — совместимый старый адрес, перенаправляющий в единый архив `/projects`.
