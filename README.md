...
- `/spatial-demo` — изолированный прототип пространственной навигации: колесо ведет по уровням профиля, опыта, проектов и связанных материалов, движение тачпада непрерывно перемещает карусели, а клик по центральной карточке раскрывает подробности радиальным эффектом капли.
